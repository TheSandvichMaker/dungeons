...
set SHARED_FLAGS=/nologo /Zo /Zi /Oi /GR- /EHa- /WX /W4 /wd4201 /fp:fast /fp:except- -DUNICODE=1 -D_CRT_SECURE_NO_WARNINGS /Iexternal
set MSVC_FLAGS=-DCOMPILER_MSVC=1 
set LLVM_FLAGS=-Wno-missing-field-initializers -Wno-unused-variable -Wno-unused-function -Wno-deprecated-declarations -Wno-writable-strings -Wno-missing-field-initializers -Wno-missing-braces -DCOMPILER_LLVM=1 -maes

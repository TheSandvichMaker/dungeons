...
set SHARED_FLAGS=-g -gcodeview -ffast-math -W -Wall -Wextra -Werror -Wno-unused-function -Wno-deprecated-declarations -Wno-unused-parameter -Wno-unused-variable -Wno-writable-strings -Wno-missing-field-initializers -DUNICODE=1 -Icode\external
